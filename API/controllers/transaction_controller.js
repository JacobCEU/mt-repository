...
const viewAllTransaction = (req,res,next)=>{
    ...
    let query = `SELECT transaction_id, recipient_name, recipient_contactNo, transaction_amt, transaaction_date, receive_date FROM transaction_tbl WHERE user_id = '${userId}'`
